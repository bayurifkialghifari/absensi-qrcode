		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>laporan/tahunIni/detail/<?= $id ?>">Tahun Ini Detail</a>
					</li>
				</ul>
			...
			<div class="col-md-12">
				...
				<section class="tile">
					...
					<div class="tile-body">
						<div class="row">
							<div class="col-md-11">
								<a style="float: right;" href="<?= base_url() ?>laporan/tahunIni/exportExcel/<?= $id ?>" target="_blank" class="btn btn-ef btn-ef-5 btn-ef-5b btn-success mb-10" ><i class="fa fa-plus"></i> <span>Export Excel</span></a>
							</div>
							<div class="col-md-1">
								<a style="float: right;" href="<?= base_url() ?>laporan/tahunIni/exportPDF/<?= $id ?>" target="_blank" class="btn btn-ef btn-ef-5 btn-ef-5b btn-danger mb-10" ><i class="fa fa-plus"></i> <span>Export PDF</span></a>
							</div>
						</div>
						<br>
								...
								<tr>
									...
									<?php 
										$exe = $this->db->select('sum(b.abse_hadir) as hadir, sum(b.abse_izin) as izin, sum(b.abse_sakit) as sakit, sum(b.abse_alpa) as alpa')
														...
														->where('YEAR(b.abse_tanggal) = YEAR(NOW())')
