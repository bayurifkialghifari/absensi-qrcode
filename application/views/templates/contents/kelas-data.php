		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>kelas/data">Data</a>
					</li>
				</ul>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<select class="form-control" name="kela" id="kela">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<select class="form-control" name="kede" id="kede">
										<option value="">--Pilih Kelas Detail--</option>
									</select>
								</div>
							</div>
							<div class="col-md-6">
