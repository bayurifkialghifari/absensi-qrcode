		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>referensi/kelasDetail">Kelas Detail</a>
					</li>
				</ul>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title custom-font" id="myModalLabel">Form Kelas Detail</h3>
				</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="tanggal">Kelas Detail</label>
									<input type="text" id="detail" class="form-control" name="detail" required="required"/>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
