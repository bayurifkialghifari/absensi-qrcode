		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>absen/keluar/<?= $id ?>">Keluar</a>
					</li>
				</ul>
		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<section class="tile">
					...
					<div class="tile-body">
						<div class="row">
							<div class="col-md-6"><div id="tableTools"></div><a href="<?= base_url() ?>absen/data" style="float: right;" class="btn btn-ef btn-ef-5 btn-ef-5b btn-warning mb-10"><i class="fa fa-plus"></i> <span>Kembali</span></a></div>
							<div class="col-md-6">
								<!-- <?php 
