		...
		<div class="pageheader">
			...
			<div class="page-bar">
				...
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="<?=base_url()?>laporan/bulanIni/detail/<?= $id ?>">Bulan Ini Detail</a>
					</li>
				</ul>
			...
			<div class="col-md-12">
				...
				<section class="tile">
					...
					<div class="tile-body">
						<div class="row">
							<div class="col-md-11">
								<a style="float: right;" href="<?= base_url() ?>laporan/bulanIni/exportExcel/<?= $id ?>" target="_blank" class="btn btn-ef btn-ef-5 btn-ef-5b btn-success mb-10" ><i class="fa fa-plus"></i> <span>Export Excel</span></a>
							</div>
							<div class="col-md-1">
								<a style="float: right;" href="<?= base_url() ?>laporan/bulanIni/exportPDF/<?= $id ?>" target="_blank" class="btn btn-ef btn-ef-5 btn-ef-5b btn-danger mb-10" ><i class="fa fa-plus"></i> <span>Export PDF</span></a>
							</div>
						</div>
						<br>
