...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>login/login.css">
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>login/login2.css">
...
<body>
	...
	<script src="<?= base_url() ?>login/login.js"></script>
