...
class MataPelajaran extends Render_Controller {
	...
	public function index() {
		...
		// Page config:
		$this->title = 'Referensi Mata Pelajaran';
		$this->content = 'referensi-mataPelajaran'; 
	...
	public function ajax_data()
	{
		...
		$data 	= $this->mataPelajaran->getAllIsi($length, $start, $cari['value'], $status)->result_array();
		$count 	= $this->mataPelajaran->getAllIsi(null,null, $cari['value'], $status)->num_rows();
		array($cari);
	...
	public function insert() {
		...
		$r = $this->mataPelajaran->insert($nama, $keterangan, $status);
	...
	public function update() {
		...
		$r = $this->mataPelajaran->update($id, $nama, $keterangan, $status);
	...
	public function delete() {
		...
		$r = $this->mataPelajaran->delete($id);
	...
	function __construct() {
		...
		$this->load->model('referensi/mataPelajaran_model', 'mataPelajaran');
		// cek session
