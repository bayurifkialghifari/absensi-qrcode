...
class Data extends Render_Controller {
	...
	public function insert() {
		...
		$r = $this->kelas->insert($kela, $kede, $angkatan, $jurusan);
	...
	public function update() {
		...
		$r = $this->kelas->update($id, $kela, $kede, $angkatan, $jurusan);
	...
	function __construct() {
		...
		$this->load->model('kelas/data_model', 'kelas');
		// cek session
