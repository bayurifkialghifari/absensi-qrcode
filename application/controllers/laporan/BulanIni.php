...
class BulanIni extends Render_Controller {

	public function index() {

		// Page config:
		$this->title = 'Laporan';
		$this->content = 'laporan-bulanIni'; 
	...
	public function detail($id)
	{
		// Page config:
		$this->title = 'Laporan';
		$this->content = 'laporan-bulanIni-detail'; 
		$this->plugins = ['datatables'];
		$this->navigation = ['Pengaturan'];
	...
	public function exportExcel($id)
	{
		...
		$this->load->view('laporan/excel/bulanIni', $data);
	}
	...
	{	
		...
		$html 			= $this->load->view('laporan/pdf/bulanIni', $data, true);
		...
		$filename 		= 'laporan_absen_'.$data['kelas']."_bulan_ini";
	...
	function __construct() {
		...
		$this->load->model('laporan/bulanIni_model', 'model');
		// cek session
