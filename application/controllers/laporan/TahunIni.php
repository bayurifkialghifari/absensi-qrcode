...
class TahunIni extends Render_Controller {

	public function index() {

		// Page config:
		$this->title = 'Laporan';
		$this->content = 'laporan-tahunIni'; 
	...
	public function detail($id)
	{
		// Page config:
		$this->title = 'Laporan';
		$this->content = 'laporan-tahunIni-detail'; 
		$this->plugins = ['datatables'];
		$this->navigation = ['Pengaturan'];
	...
	public function getDataDetailAbsenKeluar($matp = null, $sisw = null, $seme = null)
	{
		...
		$get = $this->db->select('sum(b.absk_hadir) as hadir, sum(b.absk_izin) as izin, sum(b.absk_sakit) as sakit, sum(b.absk_alpa) as alpa, b.*')
														...
														->where('YEAR(b.absk_tanggal)=YEAR(NOW())')
	...
	public function exportExcel($id)
	{
		...
		$this->load->view('laporan/excel/tahunIni', $data);
	}
	...
	{	
		...
		$html 			= $this->load->view('laporan/pdf/tahunIni', $data, true);
		...
		$filename 		= 'laporan_absen_'.$data['kelas']."_tahun_ini";
	...
	function __construct() {
		...
		$this->load->model('laporan/tahunIni_model', 'model');
		// cek session
