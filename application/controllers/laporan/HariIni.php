...
class HariIni extends Render_Controller {

	public function index() {

		// Page config:
		$this->title = 'Laporan';
		$this->content = 'laporan-hariIni'; 
	...
	public function detail($id)
	{
		// Page config:
		$this->title = 'Laporan';
		$this->content = 'laporan-hariIni-detail'; 
		$this->plugins = ['datatables'];
		$this->navigation = ['Pengaturan'];
	...
	public function exportExcel($id)
	{
		...
		$this->load->view('laporan/excel/hariIni', $data);
	}
	...
	{	
		...
		$html 			= $this->load->view('laporan/pdf/hariIni', $data, true);
		...
		$filename 		= 'laporan_absen_'.$data['kelas']."_".psql_date_format();
	...
	function __construct() {
		...
		$this->load->model('laporan/hariIni_model', 'model');
		// cek session
